export const blogPosts = [
  {
    ...
    body: [
      ...
      "The event brought Prem Industries India Limited into direct conversation with food, hospitality, retail, and packaging-focused businesses.",
    ...
    sections: [
      {
        heading: "Prem Industries India Limited at AAHAR 2026",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "AAHAR also gave Prem Industries India Limited an opportunity to meet prospective buyers and continue business discussions after the exhibition.",
        ],
        points: [
    ...
    faq: [
      ...
      {
        question:
          "Why did Prem Industries India Limited participate in AAHAR 2026?",
        answer:
