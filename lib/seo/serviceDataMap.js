...
export const serviceDataMap = {
  packaging: {
    ...
    intro:
      "Prem Industries India Limited supports D2C, retail, and B2B packaging requirements in India through custom packaging execution, bulk supply capability, and delivery-focused coordination for growing brands.",
    sections: [
      {
  ...
  "injection-molding": {
    ...
    intro:
      "Prem Industries India Limited delivers injection molding support for OEM and industrial buyers that need repeatable plastic component quality, scale-ready throughput, and structured production control.",
    sections: [
      {
  ...
  "sheet-metal": {
    ...
    intro:
      "Prem Industries India Limited supports sheet metal fabrication programs for OEM and industrial buyers with precision-focused execution, scalable throughput, and dependable delivery reliability.",
    sections: [
      {
