// SEO Configuration - Extracted from _app.js for performance optimization
// This allows the SEO config to be static and cached at build time
...
import {
  getCanonicalPath,
  isRedirectSourcePath,
  normalizeRoutePath,
} from "@/lib/seo/routeRules";
...
// Keyword extraction from architecture
...
function toIsoDate(value) {
  ...
  const parsed = new Date(value.replace(/^Published\s+/i, "").trim());
...
const aboutPathByKey = {
  "prem-group": "/about/prem-group",
  "group-ecosystem": "/about/group-ecosystem",
  "chairmans-office": "/about/chairmans-office",
  leadership: "/about/leadership",
  "our-journey": "/about/our-journey",
  awards: "/about/awards",
};

const dynamicAboutSeoByPath = Object.entries(aboutPathByKey).reduce(
  (acc, [key, path]) => {
    const page = aboutSubpages[key];

    if (!page) {
      return acc;
    }

    const sectionHeadings = (page.sections || [])
      .map((section) => section.heading)
      .filter(Boolean)
      .slice(0, 3);

    acc[path] = {
      title: page.metaTitle || `${page.title} | Prem Industries India Limited`,
      description:
        page.metaDescription ||
        page.description ||
        "Learn more about Prem Industries India Limited.",
...
const dynamicBlogSeoByPath = blogPosts.reduce((acc, post) => {
  const keywords = getKeywordsForMetadata([
    post.title,
    post.category,
    post.venue,
    "Prem Industries India Limited",
    "industrial event update India",
    "manufacturing exhibition India",
  ]);

  acc[`/blogs/${post.slug}`] = {
    title: `${post.title} | Prem Industries India Limited`,
    description: post.excerpt,
    keywords,
    image: post.heroImage || post.coverImage || "/logo-main-desktop.png",
    article: {
      schemaType: "BlogPosting",
      headline: post.title,
      description: post.excerpt,
      image: post.heroImage || post.coverImage || "/logo-main-desktop.png",
      authorName: "Prem Industries India Limited",
      datePublished: toIsoDate(post.publishedLabel),
      dateModified: post.lastModified || toIsoDate(post.publishedLabel),
    },
  };
...
export const DEFAULT_SEO = {
  ...
  description:
    "Prem Industries India Limited supports industrial customers with OEM manufacturing, production support, and end-to-end manufacturing services.",
  keywords: getKeywordsForMetadata(parentAuthorityKeywords.slice(0, 5)),
  image: "/logo-main-desktop.png",
};

export function getPathKeywords(path) {
  const pathTerms = normalizeRoutePath(path)
    .split("/")
    .filter(Boolean)
    .map((segment) => segment.replace(/-/g, " "))
    .filter(Boolean);

  return getKeywordsForMetadata([
    ...pathTerms,
    "Prem Industries India Limited",
    "industrial manufacturing company India",
...
export const SEO_BY_PATH = {
  "/": {
    title: "Prem Industries India Limited | Industrial Manufacturing Company",
    description:
      "Prem Industries India Limited provides industrial manufacturing in India and OEM solutions across sheet metal fabrication, injection moulding and packaging solutions.",
    keywords: homepageKeywords,
    image: "/home/hero-packaging.jpg",
  },
  "/about": {
    title: "About Prem Industries India Limited | Industrial Company India",
    description:
      "Learn about Prem Industries India Limited, our manufacturing capabilities, and the values that guide our work.",
    keywords:
      "Prem Industries India Limited, manufacturing capabilities, industrial engineering, company overview",
    image: "/about/banner.jpg",
  },
  "/clients": {
    ...
    keywords:
      "Prem Industries India Limited clients, industrial clients India, sector partnerships",
    image: "/clients/banner.jpg",
  },
  "/blogs": {
    title: "Blogs & Events | Prem Industries India Limited",
    description:
      "Read recent blogs, exhibition updates, and event highlights from Prem Industries India Limited, including our recent AAHAR 2026 update.",
    keywords:
      "Prem Industries India Limited blogs, industrial events India, manufacturing event updates, AAHAR 2026 Prem Industries India Limited",
    image: "/aahar/AaharBanner2026.jpeg",
  },
  "/contact": {
    ...
    keywords:
      "contact Prem Industries India Limited, industrial manufacturing inquiry, sheet metal supplier India",
    image: "/contact/banner.jpg",
  },
  "/career": {
    title: "Careers | Prem Industries India Limited",
    description:
      "Explore careers at Prem Industries India Limited across manufacturing, operations, quality, engineering, planning, and industrial business functions.",
    keywords:
      "Prem Industries India Limited careers, manufacturing jobs India, industrial company careers, operations jobs India",
    image: "/about/banner.jpg",
  },
  "/privacy-policy": {
    ...
    keywords: "privacy policy, Prem Industries India Limited privacy",
  ...
  "/terms-and-conditions": {
    ...
    keywords: "terms and conditions, Prem Industries India Limited terms",
  ...
  "/sheet-metal-fabrication-india": {
    title: "Sheet Metal Fabrication India | Prem Industries India Limited",
    description:
  ...
  "/sheet-metal-manufacturer-india": {
    title: "Sheet Metal Manufacturer India | Prem Industries India Limited",
    description:
  ...
  "/custom-sheet-metal-fabrication": {
    title: "Custom Sheet Metal Fabrication | Prem Industries India Limited",
    description:
  ...
  "/precision-sheet-metal-parts": {
    title: "Precision Sheet Metal Parts | Prem Industries India Limited",
    description:
  ...
  "/laser-cutting-services-india": {
    title: "Laser Cutting Services India | Prem Industries India Limited",
    description:
  ...
  "/cnc-sheet-metal-fabrication": {
    title: "CNC Sheet Metal Fabrication | Prem Industries India Limited",
    description:
  ...
  "/metal-bending-services": {
    title: "Metal Bending Services | Prem Industries India Limited",
    description:
  ...
  "/welding-fabrication-services": {
    title: "Welding Fabrication Services | Prem Industries India Limited",
    description:
  ...
  "/oem-sheet-metal-manufacturer": {
    title: "OEM Sheet Metal Manufacturer | Prem Industries India Limited",
    description:
  ...
  "/sheet-metal-fabrication-quote": {
    title: "Sheet Metal Fabrication Quote | Prem Industries India Limited",
    description:
  ...
  ...dynamicAboutSeoByPath,
  ...dynamicBlogSeoByPath,
  "/injectionmoulding": {
    title: "Injection Molding Manufacturer India | Prem Industries India Limited",
    description:
  ...
  "/plastic-injection-molding-company": {
    title: "Plastic Injection Molding Company | Prem Industries India Limited",
    description:
  ...
  "/custom-plastic-molding": {
    title: "Custom Plastic Molding | Prem Industries India Limited",
    description:
  ...
  "/oem-injection-molding-india": {
    title: "OEM Injection Molding India | Prem Industries India Limited",
    description:
  ...
  "/high-precision-plastic-molding": {
    title: "High Precision Plastic Molding | Prem Industries India Limited",
    description:
  ...
  "/manufacturing-company-india": {
    title: "Industrial Manufacturing Company India | Prem Industries India Limited",
    description:
      "Prem Industries India Limited supports contract manufacturing, OEM programs, and end-to-end production solutions for industrial customers.",
    keywords: manufacturingCompanyKeywords,
    image: "/home/hero-packaging.jpg",
  },
  "/industrial-solutions-india": {
    title: "Industrial Solutions Provider India | Prem Industries India Limited",
    description:
  ...
  "/oem-manufacturing-india": {
    title: "OEM Manufacturing Company India | Prem Industries India Limited",
    description:
      "OEM manufacturing support with contract production services, factory-scale capability, and quality-led industrial execution.",
    keywords: oemManufacturingKeywords,
    image: "/home/hero-packaging.jpg",
  },
  "/contract-manufacturing-india": {
    title: "Contract Manufacturing India | Prem Industries India Limited",
    description:
  ...
  "/industrial-manufacturing-services": {
    title: "Industrial Manufacturing Services | Prem Industries India Limited",
    description:
  ...
  "/custom-product-manufacturing-india": {
    title: "Custom Product Manufacturing India | Prem Industries India Limited",
    description:
  ...
  "/third-party-manufacturing-india": {
    title: "Third Party Manufacturing India | Prem Industries India Limited",
    description:
  ...
  "/turnkey-manufacturing-services": {
    title: "Turnkey Manufacturing Services | Prem Industries India Limited",
    description:
  ...
  "/redirects/whatsnew/coolers": {
    title: "Cooler Components Manufacturing | Prem Industries India Limited",
    description:
  ...
  "/redirects/whatsnew/chimney": {
    title: "Smart Kitchen Chimneys for Next India | Prem Industries India Limited",
    description:
  ...
  "/case-studies": {
    ...
    description:
      "Read real-world case studies from Prem Industries India Limited across sheet metal, injection moulding, and coil processing operations.",
    keywords:
  ...
  "/case-studies/sheet-metal-automotive-bracket-line": {
    title: "Automotive Bracket Line Stabilization | Prem Industries India Limited Case Study",
    description:
    ...
    image: "/sheetmetal/press-new.jpg",
    article: {
      headline: "Automotive Bracket Line Stabilization Case Study",
      description:
        "Case study on improving dimensional consistency and dispatch reliability in a sheet metal automotive bracket program.",
      image: "/sheetmetal/press-new.jpg",
      authorName: "Prem Industries India Limited",
  ...
  "/case-studies/injection-molding-appliance-housing": {
    title:
      "Injection Moulding Appliance Housing Ramp-Up | Prem Industries India Limited Case Study",
    description:
    ...
    image: "/injectionmolding/injection.webp",
    article: {
      headline: "Injection Moulding Appliance Housing Ramp-Up Case Study",
      description:
        "Case study on scaling appliance housing production through process control and stable injection moulding output.",
      image: "/injectionmolding/injection.webp",
      authorName: "Prem Industries India Limited",
  ...
  "/case-studies/coil-processing-fast-turnaround": {
    title:
      "Coil Processing Fast-Turnaround Program | Prem Industries India Limited Case Study",
    description:
    ...
    image: "/sheetmetal/slitting-1.jpg",
    article: {
      headline: "Coil Processing Fast-Turnaround Program Case Study",
      description:
        "Case study on improving material conversion turnaround using coordinated CTL, shearing, and slitting workflows.",
      image: "/sheetmetal/slitting-1.jpg",
      authorName: "Prem Industries India Limited",
...
export function getSeoData(path = "/") {
  ...
  const pathData =
    SEO_BY_PATH[canonicalPath] || SEO_BY_PATH[normalizedPath] || DEFAULT_SEO;
  const keywords =
    pathData.keywords || getPathKeywords(canonicalPath) || DEFAULT_SEO.keywords;
...
export function isIndexablePath(path = "/") {
  const normalizedPath = normalizeRoutePath(path);
  if (isRedirectSourcePath(normalizedPath)) {
    return false;
  }

  return !getSeoData(normalizedPath).noindex;
}
