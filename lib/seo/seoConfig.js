...
export const SEO_BY_PATH = {
  "/": {
    ...
    description:
      "Prem Industries India Limited supports industrial customers with manufacturing services, OEM production support, and scalable execution across B2B sectors.",
